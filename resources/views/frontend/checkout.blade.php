                    ...
                    <div class="box_booking">
                        ...
                        <div class="main">
                            ...
                            <ul class="clearfix">
                                ...
                                <li class="total">Total<span>${{ $general ? (floatval($general->delivery_fee) + $subtotal):$subtotal }}</span></li>
                                <input type="hidden" name="total" value="{{ $general ? (floatval($general->delivery_fee) + $subtotal):$subtotal }}">
                            </ul>
