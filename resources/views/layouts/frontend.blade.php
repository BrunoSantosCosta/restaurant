					...
					<div class="col-12">
						...
						<form method="POST" action="{{ route('login') }}">
							...
							<div class="form-group mb-3">
								...
								<input class="form-control" type="email" placeholder="Entre com seu Email" id="email"
									name="email">
								@error('email')
					...
					<div class="col-12">
						...
						<form method="POST" action="{{ route('register') }}">
							...
							<div class="form-group mb-3">
								...
								<input class="form-control" type="text" placeholder="Entre Com Seu Nome" id="name"
									name="name">
								@error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
							...
							<div class="form-group mb-5">
								...
								<input class="form-control" type="password" placeholder="Confirme Sua Senha" id="password_confirmation"
							...
							<div class="form-group mb-2">
								<input class="btn_1 full-width" type="submit" value="Registrar" id="submit-contact">
							</div>
						</form>
					</div>
				</div>
