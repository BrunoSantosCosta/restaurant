        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a class="btn btn-success" href="{{ route('productCategory.create') }}">Adicionar Categoria +</a>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($productCategories as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->name }}</td>
                                    <td>
                                        <a class="btn btn-primary" href="{{ route('productCategory.edit', $item->id) }}">Editar</a>
